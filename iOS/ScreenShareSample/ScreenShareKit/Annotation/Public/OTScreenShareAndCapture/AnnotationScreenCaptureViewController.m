...
@interface AnnotationScreenCaptureViewController ()
@property (nonatomic) AnnotationScreenCaptureModel *captureModel;
@property (strong, nonatomic) AnnotationScreenCaptureView *captureView;
@property (nonatomic) UIActivityViewController *activityViewController;
@end

@implementation AnnotationScreenCaptureViewController

- (void)setSharedImage:(UIImage *)sharedImage {
    _sharedImage = sharedImage;
    _captureModel = [[AnnotationScreenCaptureModel alloc] initWithSharedImage:sharedImage sharedDate:[NSDate date]];
...
- (void)viewDidLoad {
    ...
    self.captureView = (AnnotationScreenCaptureView *)self.view;
