...
//    if ([delegate conformsToProtocol:@protocol(OTPublisherDelegate)] || [delegate conformsToProtocol:@protocol(OTPublisherKitDelegate)]) {
//        [session.publisherDelegate addObject:delegate];
//    }
//    
//    if ([delegate conformsToProtocol:@protocol(OTSubscriberDelegate)] || [delegate conformsToProtocol:@protocol(OTSubscriberKitDelegate)]) {
...
//    if ([session.publisherDelegate containsObject:delegate]) {
//        [session.publisherDelegate removeObject:delegate];
//    }
//    
//    if ([session.subscriberDelegate containsObject:delegate]) {
//        [session.subscriberDelegate removeObject:delegate];
//    }
