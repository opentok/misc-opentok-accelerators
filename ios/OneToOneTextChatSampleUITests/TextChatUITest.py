...
class TextChatUITest(unittest.TestCase):
    ...
    tcLayout = iosBaseLayout + '/UIANavigationBar[2]/UIAButton[2]'
    msgLayout = iosBaseLayout + '/UIATableView[1]/UIATableCell[2]/UIAStaticText[1]'
    textLayout = iosBaseLayout + '/UIAStaticText[X]'
    ...
    def test_send_message(self):
        ...
        self.click_control('xpath', self.baseLayout.join(control))
        self.send_keys('className', 'UIATextField', msg)
        control = list(self.controlLayout)[len(self.controlLayout)-2] = baseControls[1]
        self.click_control('xpath', self.baseLayout.join(control))
        self.assertEquals(msg, self.get_button_name(self.msgLayout))
        self.click_control('xpath', self.tcLayout)
    ...
    def test_strings_are_ok(self):
        ...
        self.assertEquals('Message', self.get_button_name(self.baseLayout.join(text)))
