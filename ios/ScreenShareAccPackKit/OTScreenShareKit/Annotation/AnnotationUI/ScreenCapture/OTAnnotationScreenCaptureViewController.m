...
- (instancetype)initWithSharedImage:(UIImage *)sharedImage {
    ...
    if (self = [super initWithNibName:NSStringFromClass([self class]) bundle:[NSBundle bundleWithURL:[[NSBundle mainBundle] URLForResource:@"OTScreenShareKitBundle" withExtension:@"bundle"]]]) {
