...
Pod::Spec.new do |s|
  ...
  s.resource_bundles = {
    'OTScreenShareKitBundle' => ['ios/ScreenShareAccPackKit/OTScreenShareKitBundle/**/*']
  }
  ...
  s.public_header_files = 'ios/ScreenShareAccPackKit/OTScreenShareKit/ScreenShare/OTScreenShareKit.h', 
    ...
    'ios/ScreenShareAccPackKit/OTScreenShareKit/Annotation/OTAnnotationKit/OTAnnotatable.h',
    'ios/ScreenShareAccPackKit/OTScreenShareKit/Annotation/OTAnnotationKit/OTAnnotationTextView.h',
    'ios/ScreenShareAccPackKit/OTScreenShareKit/Annotation/AnnotationUI/OTAnnotationScrollView.h',
    'ios/ScreenShareAccPackKit/OTScreenShareKit/Annotation/AnnotationUI/OTFullScreenAnnotationViewController.h',
    'ios/ScreenShareAccPackKit/OTScreenShareKit/Annotation/AnnotationUI/Toolbar/OTAnnotationToolbarView.h'
